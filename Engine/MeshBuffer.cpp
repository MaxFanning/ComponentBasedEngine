...
void MeshBuffer::Initialize(u32 vertexFormat, const void* vertexData, u32 numVertices, bool dynamic)
{
...
void MeshBuffer::Initialize(u32 vertexFormat, const void* vertexData, u32 numVertices, const u16* indexData, u32 numIndices, bool dynamic)
{
	GraphicsSystem* gs = GraphicsSystem::Get();

	Initialize(vertexFormat, vertexData, numVertices, dynamic);
...
void MeshBuffer::Initialize(u32 vertexFormat, const Mesh& mesh, bool dynamic)
{
	Initialize(vertexFormat, mesh.GetVertices(), mesh.GetVertexCount(), mesh.GetIndices(), mesh.GetIndexCount(), dynamic);
}
...
void MeshBuffer::UpdateBuffer(const Mesh::Vertex* vertices, u32 vertexCount)
{
	GraphicsSystem* gs = GraphicsSystem::Get();
